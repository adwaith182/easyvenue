        ...
        RouterModule.forRoot([
            {
                ...
                children: [
                    ...
                    { path: 'venue-list', component: VenueCategoryListComponent },
                    { path: 'my-profile', component: MyAccountComponent },
                    { path: 'edit-my-profile/:id', component: UserMyAccountEditComponent },
                    { path: 'order', component: OrdersComponent },
                    { path: 'availability', component: AvailabilityComponent },
                    { path: 'venue-order/view/:id', component: ViewCustomerVenueOrderComponent },
                    { path: 'venue-availability/view/:id', component: ViewCustomerVenueAvailabilityComponent },
                    { path: 'auth/reset-pass/:token', component: ResetPasswordComponent },
            ...
            {
                path: 'manage', component: AppMainComponent, canActivate: [AuthGuard],
                canActivateChild: [AuthGuard],
                data: {
                    role: ['admin'],
                },
                children: [
                    ...
                    { path: 'category/category/:id', component: CategoryEditComponent },
                    { path: 'category/category/view/:id', component: CategoryViewComponent },
                    { path: 'category/subcategory', component: SubcategoryComponent },
                    { path: 'category/subcategory/add', component: SubcategoryAddComponent },
                    { path: 'category/subcategory/:id', component: SubcategoryEditComponent },
                    { path: 'category/subcategory/view/:id', component: SubcategoryViewComponent },
                    { path: 'customer/user', component: UserComponent },
                    { path: 'customer/user/add', component: UserAddComponent },
                    { path: 'customer/user/:id', component: UserEditComponent },
                    { path: 'customer/user/view/:id', component: UserViewComponent },
                    { path: 'cmsmodule', loadChildren: () => import('./manage/cmsmodule/cmsmodule.module').then(m => m.CmsmoduleModule), },
                    { path: 'banner', component: BannerComponent },
                    { path: 'banner/add', component: BannerAddComponent },
                    { path: 'banner/:id', component: BannerEditComponent },
                    { path: 'calendar', component: CalendarComponent },
                    { path: 'customer/news-letter', loadChildren: () => import('./manage/newsletter/newsletter.module').then(m => m.NewsLetterModule), },
                    { path: 'customer/contact-us', loadChildren: () => import('./manage/contactus/contactus.module').then(m => m.ContactUsModule), },
                    { path: 'venue', loadChildren: () => import('./manage/venue/venue.module').then(m => m.VenuemoduleModule), },
                    { path: 'vendor', loadChildren: () => import('./manage/vendor/vendor.module').then(m => m.VendorModule), },
                    { path: 'caterer', loadChildren: () => import('./manage/caterer/caterer.module').then(m => m.CatererModule), },
                    { path: 'customer/productreview', loadChildren: () => import('./manage/productreview/productreview.module').then(m => m.ProductreviewModule), },
                    { path: 'customer/orderreview', loadChildren: () => import('./manage/orderreview/orderreview.module').then(m => m.OrderreviewModule), },
                    //{ path: 'location/country', loadChildren: () => import('./manage/country/country.module').then(m => m.CountryModule), },
                    { path: 'venue/order/:venueid', component: VenueorderListComponent },
                    { path: 'venue/order/view/:venueid', component: ViewvenueorderComponent },
                    ...
                    { path: 'venue/slot', component: SlotManagementComponent },
                    { path: 'venue/slot/add', component: AddVenueSlotManagementComponent },
                    { path: 'venue/slot/:id', component: EditVenueSlotManagementComponent },
                    { path: 'venue/slot-availability/:id', component: VenueSlotAvailabilityComponent },
                    { path: 'eventplanner', component: EventplannerListComponent },
                    { path: 'location/state', loadChildren: () => import('./manage/state/state.module').then(m => m.StateModule), },
                    { path: 'location/city', loadChildren: () => import('./manage/city/city.module').then(m => m.CityModule), },
                    { path: 'location/subarea', loadChildren: () => import('./manage/subarea/subarea.module').then(m => m.SubareaModule), },
