...
export class UserComponent implements OnInit {
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                ...
                this.userService.updateUser(user.id, userData).subscribe(
                    data => {
                        this.messageService.add({ key: 'toastmsg', severity: 'success', summary: 'Successful', detail: 'User Deleted', life: 3000 });
    ...
    viewUser(id) {
        this.router.navigate(['/manage/customer/user/view/' + id]);
    }

    editUser(id) {
        this.router.navigate(['/manage/customer/user/' + id]);
    }
    ...
    changeStatus(user) {
        this.confirmationService.confirm({
            ...
            accept: () => {
                ...
                this.userService.updateUser(user.id, userData).subscribe(
                    data => {
                        this.messageService.add({ key: 'toastmsg', severity: 'success', summary: 'Successful', detail: 'User Status Updated', life: 3000 });
                        this.getUserDetails(user.id);
                    },
                    err => {
                        this.errorMessage = err.error.message;
