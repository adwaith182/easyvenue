...
export class VenueorderListComponent implements OnInit {
  ...
  constructor(private venueorderService: VenueorderService, private messageService: MessageService, private titlecasePipe: TitleCasePipe, private router: Router, private confirmationService: ConfirmationService) { }
  ngOnInit() {
    this.cols = [
