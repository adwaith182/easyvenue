...
class SeedService {
  ...
  async seed() {
    try {
      ...
      await this.addRole();
      const countriesData = require('./../defaultdata/countries.json');
      const country = await commonService.addMany(countriesData, 'countries');
      const statesData = require('./../defaultdata/states.json');
      const states = await commonService.addMany(statesData, 'states');
      const citiesData = require('./../defaultdata/cities.json');
